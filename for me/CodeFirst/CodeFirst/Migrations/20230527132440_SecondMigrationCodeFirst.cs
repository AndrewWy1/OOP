...
{
    /// <inheritdoc />
    public partial class SecondMigrationCodeFirst : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2L, new DateTime(1981, 4, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "jan.kricten@gmail.com", "Jan", "Kirsten", "111-222-3333" }
                });
        }

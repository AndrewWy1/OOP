...
SET IDENTITY_INSERT AircraftType ON
INSERT INTO AircraftType (aircraft_type_id, [type_name]) VALUES 
...
SET IDENTITY_INSERT AircraftType OFF

SET IDENTITY_INSERT Passenger ON
INSERT INTO Passenger (passenger_id, full_name, email) VALUES 
...
INSERT INTO Pilot (pilot_id, first_name, last_name, age, rating) VALUES 
...
INSERT INTO Aircraft (aircraft_id, manufacturer, model, [year], flight_hours, condition, aircraft_type_id) VALUES 
...
SET IDENTITY_INSERT FlightDestination ON
INSERT INTO FlightDestination (flight_destination_id, airport_id, [start], aircraft_id, passenger_id, ticket_price, first_pilot_id, second_pilot_id) values 
...
SET IDENTITY_INSERT FlightDestination OFF
